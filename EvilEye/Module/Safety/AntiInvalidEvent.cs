...
namespace EvilEye.Module.Safety
{
    ...
    {
        public AntiInvalidEvent() : base("AntiInvalidEvent", "Anti for all the Photon Exploits", Main.Instance.safetyButton, null, true, true)
        {
        }
        ...
        public bool OnEvent(EventData eventData)
        {
            switch (eventData.Code)
            {
                ...
                case 210:
                    ...
                    if (il2CppStructArray[1] != eventData.Sender)
                    {
                        return false;
                    }
                    break;
